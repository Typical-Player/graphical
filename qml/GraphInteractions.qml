...
Item {
    ...
    required property bool hasTouchInput

    readonly property bool isMobile: root.hasTouchInput || gv.width <= 700
    ...
    readonly property bool isDraggingSelection: root.selectionMode &&
    ...
    PinchArea {
        ...
        MouseArea {
            ...
            onWheel: function (wheel) {
                ...
                const isSmooth = (Math.abs(wheel.angleDelta.y) % 120 !== 0) || hasPixelDelta;
